...
- Epic alignment: Epic 2 (Profiles & Trust Signals) — company profile creation. [Source: docs/prd/epic-2-profiles-trust-signals.md#Epic-2-Profiles-&-Trust-Signals]
- Dependencies: Auth and role-guarded access from Epic 1 must be available (company role, JWT cookie). [Source: docs/architecture/api-specification.md#paths]
...
- Auth is cookie-based; cross-site requires `SameSite=None` in production for profile creation. [Source: docs/stories/2.1.company-profile-creation.md#Completion-Notes-List]

**Relevant Source Tree**
- `apps/api/src/modules/company` (module/controller/service pattern per backend architecture) [Source: docs/architecture/source-tree.md#Story-1.1-placement-notes]
- `apps/api/src/modules/auth` (role guards and DTO validation patterns) [Source: docs/architecture/source-tree.md#Story-1.1-placement-notes]
- `apps/web/src/app/company` (company routes) [Source: docs/architecture/source-tree.md#Story-1.1-placement-notes]
- `apps/web/src/app/freelancer` (freelancer-facing views) [Source: docs/architecture/source-tree.md#Story-1.1-placement-notes]
- `apps/web/src/services` (API client/service layer) [Source: docs/architecture/source-tree.md#Story-1.1-placement-notes]
- `packages/shared/src/types` (shared domain types) [Source: docs/architecture/source-tree.md#Story-1.1-placement-notes]
- `apps/api/src/migrations` (TypeORM migrations) [Source: docs/architecture/source-tree.md#Story-1.1-placement-notes]

**Data Models (from `docs/architecture/data-models.md`)**
- CompanyProfile: `id`, `userId`, `name`, `description`, `contactEmail`, `location`. [Source: docs/architecture/data-models.md#CompanyProfile]
- Relationship: CompanyProfile 1:1 User. [Source: docs/architecture/data-models.md#CompanyProfile]

**API Specifications**
- Company profile endpoints: `GET/POST/PUT /company/profile`, public `GET /company/{companyId}`. [Source: docs/architecture/api-specification.md#paths]
...
- Follow testing strategy patterns in `docs/architecture/testing-strategy.md`. [Source: docs/architecture/testing-strategy.md#Testing-Strategy]

**Assumptions & Edge Cases**
- Unauthenticated requests to `/company/profile` should return 401. [Source: docs/architecture/api-specification.md#security]
- Company profile `userId` must be unique (one profile per company). [Source: docs/architecture/data-models.md#CompanyProfile]
