...
- [Maritime Expert Marketplace MVP Fullstack Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    ...
    - [CompanyProfile](./data-models.md#companyprofile)
    - [FreelancerProfile](./data-models.md#freelancerprofile)
    - [Job](./data-models.md#job)
    - [Application](./data-models.md#application)
    - [Message](./data-models.md#message)
    - [AdminAction](./data-models.md#adminaction)
  - [API Specification](./api-specification.md)
  - [Components](./components.md)
    - [Web App (Next.js)](./components.md#web-app-nextjs)
    - [API Service (NestJS)](./components.md#api-service-nestjs)
    - [Database (PostgreSQL)](./components.md#database-postgresql)
    - [Shared Types Package](./components.md#shared-types-package)
    - [Auth Module](./components.md#auth-module)
