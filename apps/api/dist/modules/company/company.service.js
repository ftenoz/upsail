...
let CompanyService = class CompanyService {
    ...
    async createProfile(userId, dto) {
        ...
        if (existing) {
            throw new common_1.BadRequestException("Company profile already exists.");
        }
...
exports.CompanyService = CompanyService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(company_profile_entity_1.CompanyProfile)),
